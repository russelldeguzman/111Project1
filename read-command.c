		     ...
		     void *get_next_byte_argument)
{
  ...
  */
  ...
  //INIT STACKS
    stack operatorStack;
    stack commandStack;
    command_t currCommand = (command_t) malloc(sizeof(struct command)); //init first command
